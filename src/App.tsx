...
function App() {
  ...
  return (
    ...
    >
      ...
      <main className="flex min-h-0 flex-1 flex-col items-center gap-3 overflow-hidden px-4 py-2">
        <div className="flex min-h-0 w-full flex-1 items-center justify-center">
          <div className="flex max-h-full w-full max-w-md flex-col overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-6 shadow-2xl backdrop-blur-xl sm:max-w-lg sm:p-10">
            {!isDrawingOrResult && (
